...
namespace Hellion
{
    ...
    public:
        ...
        HDevice(HWindow &windowRef) : window{windowRef} { init(); }
...
#error Invalid VMA_VULKAN_VERSION.
    return UINT32_MAX;
        ...
        void
        transitionImageLayout(vk::Image image, vk::Format format, vk::ImageLayout oldLayout, vk::ImageLayout newLayout, uint32_t mipLevels, uint32_t layerCount)
        {
